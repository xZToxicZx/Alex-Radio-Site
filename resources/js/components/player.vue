                ...
                <div class="col-sm-4 align-self-center">
                    <div class="row">
                        <div class="col-sm-7">
                            ...
                            <input type="range" orient="vertical" max="1" min="0.01" step="0.01" v-model="player.volume" @input="updateVolume" @change="updateVolume" />
                        </div>
                        <div class="col-sm-1">
                            <a class="text-white-50" href="https://www.facebook.com/TreeHouseRadios/"><i class="fab fa-facebook-square"></i></a>
                            <a class="text-white-50" href="https://www.twitch.tv/treehouseradios"><i class="fab fa-twitch"></i></a>
                            <a class="text-white-50" href="https://discord.treehouseradios.com"><i class="fab fa-discord"></i></a>
                        </div>
                    </div>
                </div>
